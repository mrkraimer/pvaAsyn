...
dbLoadDatabase("$(TOP)/dbd/adioc.dbd")
adioc_registerRecordDeviceDriver(pdbbase) 
...
startPVAServer
pvaAsyn "sim1Port" "SIM1" "MIN_X,MIN_Y,SIZE_X,SIZE_Y,ACQUIRE,ARRAY_CALLBACKS"
pvaAsyn "image1Port" "Image1" "ENABLE_CALLBACKS,NDARRAY_PORT"
pvaAsyn "roi1Port" "ROI1" "ENABLE_CALLBACKS,DIM0_ENABLE,DIM1_ENABLE,DIM0_MIN,DIM1_MIN,DIM0_SIZE,DIM1_SIZE"
pvdbl
